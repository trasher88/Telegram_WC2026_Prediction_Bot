...
Это нужно потому, что матчи проходят в США, а участники играют по московскому времени. В один игровой день попадают вечерние и ночные матчи по Москве.
...
```text
📊 Итоги игрового дня — 11 июня

⚽ Матчи:
🇲🇽 Мексика — 🇿🇦 ЮАР 3:0
🇰🇷 Южная Корея — 🇨🇿 Чехия 2:2

🏆 Очки за игровой день:
🥇 Ванек — 5 очков
🥈 Чувак — 3 очка
• Степан — 0 очков
...
3. при полном равенстве — стабильная сортировка по `user_id`.
...
Если токен случайно попал в публичный репозиторий, его нужно перевыпустить у BotFather / football-data, а не просто удалить файл из последнего commit.
