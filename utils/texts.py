...
HELP_TEXT = (
    ...
    "🔔 Уведомления\n"
    "• 13:00 МСК — всем игрокам приходит список матчей игрового дня.\n"
    "• 18:00 МСК — напоминание тем, кто ещё не поставил все прогнозы.\n\n"
    ...
    "• Очковая эффективность — сколько очков набрано от максимума.\n"
